...
The PICRUSt pipeline ends with metagenome prediction, as described in :ref:`metagenome_prediction_tutorial`. From there, you can analyze your predicted metagenomes as you would analyze actual metagenomes, with the tool of your choice. Here we provide some recommendations for analyzing metagenomes with QIIME.
