...
pfam_ace_recall<-read.delim("results/pfam_ace_recall_accuracy.txt",header=FALSE)
pfam_ace_precision<-read.delim("results/pfam_ace_precision_accuracy.txt",header=FALSE);
...
role_ace_recall<-read.delim("results/role_ace_recall_accuracy.txt",header=FALSE)
role_ace_precision<-read.delim("results/role_ace_precision_accuracy.txt",header=FALSE);
...
subsystem_ace_recall<-read.delim("results/subsystem_ace_recall_accuracy.txt",header=FALSE)
subsystem_ace_precision<-read.delim("results/subsystem_ace_precision_accuracy.txt",header=FALSE);
...
EC_ace_recall<-read.delim("results/EC_ace_recall_accuracy.txt",header=FALSE)
EC_ace_precision<-read.delim("results/EC_ace_precision_accuracy.txt",header=FALSE);
...
vioplot(pfam_ace_precision[,2],at=5,add=TRUE,sm_density=FALSE)
vioplot(pfam_ace_recall[,2],at=6,add=TRUE,sm_density=FALSE)
...
vioplot(role_ace_precision[,2],at=11,add=TRUE,sm_density=FALSE)
vioplot(role_ace_recall[,2],at=12,add=TRUE,sm_density=FALSE)
...
vioplot(subsystem_ace_precision[,2],at=17,add=TRUE,sm_density=FALSE)
vioplot(subsystem_ace_recall[,2],at=18,add=TRUE,sm_density=FALSE)
...
vioplot(EC_ace_precision[,2],at=23,add=TRUE,sm_density=FALSE)
vioplot(EC_ace_recall[,2],at=24,add=TRUE,sm_density=FALSE)
